...
OFILES = main.o game2Lib.o LifeGame.o play.o pause.o next.o 1.o 2.o clear.o nextModeButton.o normalModeButton.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = game2Lib.h LifeGame.h play.h pause.h next.h 1.h 2.h clear.h nextModeButton.h normalModeButton.h
